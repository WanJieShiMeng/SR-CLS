...
def resnet50(pretrained=False, in_channel=3, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet([3, 4, 6, 3], in_channel=in_channel,**kwargs)
    if pretrained:
...
class ResNet(nn.Module):
    ...
    def __init__(self, layers, in_channel = 3, num_classes=1000, model_path="model.pkl"):
