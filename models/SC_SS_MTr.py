...
from models.SC_SS_MTr_pos_embed import get_2d_sincos_pos_embed
from models.SC_SS_MTr_nt_xent import NTXentLoss
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_contrastive(self, x1, x2, y=None, mode='Siam', temperature=1.0):
        ...
        if mode == 'Siam':
            ...
            z2 = self.ph1(x2)[:, 0, :]
            cl_loss = NTXentLoss(device=torch.device("cuda:0" if torch.cuda.is_available() else "cpu"),
