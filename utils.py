...
def show_results(results, vis, label_values=None, agregated=False, path=None):
    text = ""
...
def sample_gt(gt, train_size, mode='random'):
    ...
    if mode == 'random':
       train_indices, test_indices = sklearn.model_selection.train_test_split(X, train_size=train_size, stratify=y) # random_state=42
